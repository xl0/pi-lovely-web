...
- Runtime dependency: `@xl0/pi-lovely-config`. Pi APIs and `@earendil-works/pi-ai` are peer dependencies with minimum version `>=0.79.10`.
...
WebToolsConfig { webSearchProvider, webFetchProvider, webImageEnabled, webImageResize, webImageMaxSize, smartSearchEnabled, smartSearchModel, smartSearchMaxTokens, firecrawlApiKey, exaApiKey, tavilyApiKey, braveApiKey }
```
